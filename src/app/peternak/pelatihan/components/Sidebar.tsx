        ...
        <aside className="bg-green-600 text-white w-64 flex flex-col justify-between min-h-screen py-6 px-4">
            <div>
                ...
                <nav className="space-y-4">
                    <a href="/dashboard/peternak" className="flex text-blwhiteack font-[Judson] text-xl items-center space-x-3 hover:bg-green-700 px-3 py-2 rounded">
                    ...
                    <a href="/peternak/pelatihan" className="flex items-center gap-3 font-[Judson] text-xl text-black bg-gray-100 px-5 py-2 rounded-l-full -mr-4 -ml-2 shadow-sm">
                        <Image src="/book.svg" alt="group" width={25} height={25} />
                        <span>Pelatihan</span>
                    </a>
