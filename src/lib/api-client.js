...
// Use Vercel URL when deployed, otherwise use the environment variable or relative path
const API_BASE_URL = (process.env.NEXT_PUBLIC_API_URL || process.env.VERCEL_URL
